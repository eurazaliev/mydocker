...
1. http://aab.clouds.today/author/create/ - POST создание автора, нужно оптравить json следующего вида:
...
3. http://aab.clouds.today/book/search/ - POST поиск книги по названию.
